...
def main():
    ...
    parser.add_argument('--triples', nargs=3, action='append', metavar=('S', 'R', 'A'),
                        help="SAMPLE REGION AREA triples")
    ...
    parser.add_argument('--depth-col', default='cortical_depth',
                        help="Depth column for violins")
    parser.add_argument('--spot-size', type=float, default=1.0,
                        help="Spot size for AP plots")
    ...
    for h5 in args.h5ads:
        logging.info(f"Processing file: {h5}")
        ...
        # Uncomment if you have a summary CSV to plot:
        # call('bubble_plot.R', [
